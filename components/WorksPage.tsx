...
export function WorksPage() {
  ...
  const baseProjects = [
    ...
    {
      title: "音楽制作活動",
      description: "Nintendo SwitchのKORG Gadgetで毎日15秒の楽曲制作を習慣化。身近な創作体験として楽しみながら、AIで画像を組み合わせた動画制作で遊び心のあるプロダクトを創出。",
      longDescription: "ゲーム機のSwitchソフト「KORG Gadget」を使ったミニマルな音楽制作活動です。毎日15秒くらいの短い音楽を作る習慣をつけて、身近な創作体験を楽しんでいます。作った楽曲にはタイトルをつけています。気に入った音楽にはAIで画像を当て込んで動画にして、プロダクトっぽいものを作って楽しんでいました。このシンプルな活動を通じて、音楽制作から動画制作まで一人で完結できるクリエイティブワークフローを身につけることができ、創作を日常の楽しい習慣として続けています。",
      image: getProjectImage("音楽制作活動"),
      images: getProjectScreenshots("音楽制作活動"),
      tags: ["KORG Gadget", "Nintendo Switch", "毎日制作", "AI画像生成", "動画制作", "日常創作"],
      ...
      status: "継続中",  
      platform: "個人制作",
      approach: "身近で持続可能な創作習慣",
      features: [
        "Switch「KORG Gadget」による手軽な音楽制作",
        "毎日15秒程度の短い楽曲制作習慣",
        "楽曲へのタイトル付けによるストーリー性",
        "AI画像生成と楽曲の組み合わせ動画制作",
        "身近な創作体験を重視したアプローチ",
      ...
      techDetails: "ゲーム機という身近なツールを活用することで、敷居の低い音楽制作環境を実現。短時間での制作を習慣化し、AIツールと組み合わせることで一人でも完成度の高いコンテンツを作る楽しさを発見しました。"
    },
    {
      title: "おえかきシューター",
      ...
      tags: ["チームリーダー", "受賞作品", "Trello", "プロジェクト管理"],
      category: "ゲーム開発",
      ...
      techDetails: "子供の創造力を育むゲームシステムを設計・実装。初回のチーム開発でしたが、プロジェクト管理ツールの戦略的活用と定期的な振り返りにより、予定通りの完成と受賞を達成しました。"
    },
    {
      title: "メービードゥーン",
    ...
    },
    {
      ...
      longDescription: "専門学校2年次に就職活動用として制作した、技術力をアピールする3Dホラーゲームです。Unity等の既存エンジンに頼らず、DirectX 11を直接使用して開発することで、プログラミングの深い理解を実証。A*経路探索アルゴリズムによる賢い敵AIの実装、独自のステージエディタ開発など、技術的に挑戦的な要素を多数盛り込んだ個人制作の力作です。",
      ...
      techDetails: "既存のゲームエンジンに頼らず、DirectX 11を直接操作することで、3Dグラフィックスの基本原理から深く理解。メモリ管理、レンダリングパイプライン、シェーダープログラミングなど、短期間で技術力の高さを証明する作品を完成させました。"
    },
    {
      title: "創作漫画制作",
